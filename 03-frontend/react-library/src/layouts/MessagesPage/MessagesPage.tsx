            ...
            <nav>
                <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                    <button 
                        ...
                        className='nav-link active' data-bs-target='#nav-send-message'
                        id='nav-send-message-tab' data-bs-toggle='tab' type='button'
                    ...
                    <button 
                        ...
                        className='nav-link' data-bs-target='#nav-message'
                        id='nav-message-tab' data-bs-toggle='tab' type='button'
